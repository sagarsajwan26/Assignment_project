...
export const fetchStories = createAsyncThunk('stories/fetch', async ({ page = 1, limit = 10, createdBy = null, newsOnly = false } = {}, { rejectWithValue }) => {
  try {
    const res = await getStoriesApi(page, limit, createdBy, newsOnly);
